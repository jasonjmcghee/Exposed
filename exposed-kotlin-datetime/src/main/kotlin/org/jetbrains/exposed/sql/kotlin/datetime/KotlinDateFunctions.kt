...
fun timestampWithTimeZoneParam(value: OffsetDateTime): Expression<OffsetDateTime> = QueryParameter(value, KotlinOffsetDateTimeColumnType.INSTANCE)
...
fun timestampWithTimeZoneLiteral(value: OffsetDateTime): LiteralOp<OffsetDateTime> = LiteralOp(KotlinOffsetDateTimeColumnType.INSTANCE, value)
...
fun CustomTimestampWithTimeZoneFunction(functionName: String, vararg params: Expression<*>): CustomFunction<OffsetDateTime?> =
    CustomFunction(functionName, KotlinOffsetDateTimeColumnType.INSTANCE, *params)
